...
class ExternalPostGreSqlStoragePaginationHelperImpl<E> implements PaginationHelper {
    
    private final JdbcTemplate jdbcTemplate;
    
    public ExternalPostGreSqlStoragePaginationHelperImpl(JdbcTemplate jdbcTemplate) {
